...
<head>
    ...
    <title>Réinitialiser le mot de passe - ESEBAT</title>
...
<body>
    <div class="auth-card">
        <div class="auth-header">
            ...
            @endif
            <h1 class="h5 mb-0">Nouveau mot de passe</h1>
            <p class="small mb-0 opacity-90">Définissez un nouveau mot de passe (lien valide 60 minutes)</p>
        </div>
        <div class="auth-body">
            @if ($errors->any())
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" id="password" class="form-control" required
                           autocomplete="new-password" minlength="8" placeholder="Minimum 8 caractères">
                </div>
                <div class="mb-4">
